...
using namespace std;
using namespace sf;
//template permet de generer le code pour chaque type de jeu
template <class C>
...
public:
	...
	Ghost(Texture* texture, int id, C* _starter)
	{
		...
		cout << "CLASS fantome OK" << Name << endl;
		init();
...
private:
	...
	void checkCross()
	{
		...
		if (dir == NONE)
		{
			//position de blinky pour calculer la direction de Inky
